...
options.register('jetCorrections', 'L2Relative', VarParsing.VarParsing.multiplicity.list, VarParsing.VarParsing.varType.string, "Jet corrections to use: Note that they come from the GlobalTag")
...
options.register('muonHLTMatches', 'HLT_Mu15', VarParsing.VarParsing.multiplicity.list, VarParsing.VarParsing.varType.string, "HLT paths matched to muons")
